...
- Read and follow .claude/agents/BackendImplementationPlan.md for backend phase ordering, deliverables, and acceptance criteria.
- Cross-reference .claude/agents/UIAndToolsImplementationPlan.md for UI-driven API needs and tooling upgrades.
